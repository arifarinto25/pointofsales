...
from cruds import crud_item, crud_user
from schemas import schema_item, schema_user
...
@router.post("/users/{user_id}/items/", response_model=schema_item.Item)
def create_item_for_user(
    user_id: int, item: schema_item.ItemCreate, db: Session = Depends(get_db)
):
